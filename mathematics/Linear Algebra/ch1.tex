...
\begin{enumerate}
  ...
  \item $120^\circ$
  \item $\left(\frac{\sqrt{3}}{9}, -\frac{2\sqrt{3}}{9}, \frac{2\sqrt{3}}{9}\right)$
  \item $(\frac{2\sqrt{5}}{5}, -\frac{\sqrt{5}}{5}, 0)$
  \item $-x+2y+z=2$
  \item $2x+3y-z=7$
  \item $2x+y+z=3$
  \item $\frac{1}{2}\sqrt{6}$
  \item $\left(4, -3, -1\right)$
  \item Because if so, the angle between the two vectors would be $\cos^{-1}\frac{-7}{6}$, which is
    not defined.
  \item $\sqrt{\frac{7}{2}}$
