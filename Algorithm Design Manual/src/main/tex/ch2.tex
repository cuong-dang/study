...
\begin{enumerate}[label=2-\arabic*.]
      ...
      \item Because $f_1(n) \in \mathcal{O}(g_1(n))$, $\exists c_1, n_1$ such that
            ...
            $f_2(n) \in \mathcal{O}(g_2(n))$, $\exists c_2, n_2$ such that $f_2(n) \le c_2g_2(n)$ for all
            $n \ge n_2$. Choose $c_3 = \max\lbrace  c_1, c_2 \rbrace$, and
      ...
      \item $n! \gg e^n \gg 2^n = 2^{n-1} \gg n-n^3+7n^5 \gg n^3 \gg n^2 + \log{n} = n^2 \gg
                  ...
                  \log\log{n}$.
      \item $\pi^n \gg \binom{n}{5} \gg n^\pi$.
\end{enumerate}
